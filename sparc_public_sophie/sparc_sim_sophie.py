...
import numpy as np
from sparc_public_sophie.sparc_sophie import sparc_ldpc_encode, sparc_ldpc_decode, sparc_encode, sparc_decode, bit_err_rate
...
def sparc_ldpc_sim_sophie(code_params, ldpc_params, decode_params, awgn_var, rand_seed=None): 
    bits_i, beta0, x, Ab, Az, _ = sparc_ldpc_encode(code_params, ldpc_params, awgn_var, rand_seed)
    y                        = awgn_channel(x, awgn_var, rand_seed) # Produces the received vector after the channel
