...
def sparc_ldpc_sim_integrated_wrong(code_params, ldpc_params, decode_params, awgn_var, lengths, rand_seed=None):
    bits_i, beta0, x, Ab, Az = sparc_ldpc_encode(code_params, ldpc_params, awgn_var, lengths, rand_seed)
    y                        = awgn_channel(x, awgn_var, rand_seed) # Produces the received vector after the channel
    bits_o                   = sparc_ldpc_integrated_wrong_decode(y, code_params, ldpc_params, decode_params, awgn_var, rand_seed, beta0, lengths, Ab, Az)
    ber = bit_err_rate(bits_i, bits_o)
